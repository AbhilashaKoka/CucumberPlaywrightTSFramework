...
const putRequestBody = require('../../test-data/api-requests/put_api_request_body.json');
test("PUT bookingAPI request in Playwright", async ({ request }) => {
...
console.log("PUT API Response Status:", putAPIResponse.status());
